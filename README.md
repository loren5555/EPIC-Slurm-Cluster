...
- [新在线文档]([https://loren5555.github.io/EPIC-Slurm-Cluster/](https://effieguoxufei.github.io/EPIC-Slurm-Cluster/))：按用户、管理员、开发者和故障手册分类。
...
普通用户请直接阅读[用户文档](docs/user/index.md)；管理员请从[管理员文档](docs/admin/index.md)开始；部署代码的维护者请查看[开发者文档](docs/developer/index.md)；所有已知问题统一查看[故障手册](docs/troubleshooting/index.md)。一次部署、手工软件准备和历史记录见 [Other](docs/other/index.md)。
